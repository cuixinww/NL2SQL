...
async def build_meta_knowledge(config_path: Path):
    ...
    bank_mysql_client_manager.init()  # 初始化数据仓库MySQL客户端
    ...
    async with (meta_mysql_client_manager.session_factory() as meta_Session ,
        ...
        bank_mysql_repository = BankMySQLRepository(dw_session)  # 初始化数据仓库MySQL仓库
    ...
    await bank_mysql_client_manager.close()
